...
import { TOPICS_QUERY, IDEAS_FROM_TOPIC_QUERY } from "../graphql";
                  ...
                  data.get_topics.map((topic) => (
                    <Fragment>
                      <Card
                        ...
                        headStyle={{
                          backgroundColor:
                            Color[data.get_topics.indexOf(topic) % 4],
                          color: "#FFFFFF",
                          fontSize: 25,
                        }}
                        bodyStyle={{
                                ...
                                <Text level={4}>
                                  ...
                                  <NavLink
                                    ...
                                    style={{
                                      color:
                                        Color[
                                          data.get_topics.indexOf(topic) % 4
                                        ],
                                    }}
                                  >
                                    {subtopic}
      ...
      content={
        <Fragment>
          ...
          <List
            ...
            dataSource={
              ideas_from_topic.loading
                ? []
                : ideas_from_topic.error
                ? []
                : ideas_from_topic.data.get_ideas_by_topic
            }
            pagination={{
              onChange: (page) => {
                console.log(page);
